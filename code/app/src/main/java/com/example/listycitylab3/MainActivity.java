...
public class MainActivity extends AppCompatActivity implements AddCityFragment.AddCityDialogListener, EditFragment.EditCityDialogListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            EditFragment.newInstance(clickedCity).show(getSupportFragmentManager(), "edit city");
        });

        FloatingActionButton fab = findViewById(R.id.button_add_city);
        fab.setOnClickListener(v -> {
            new AddCityFragment().show(getSupportFragmentManager(), "Add City"); //hint: pass something through addcityfragment
        });
